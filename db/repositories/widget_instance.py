    ...
    async def create_instance(
        ...
        instance = WidgetInstance(
            ...
            **create_kwargs,
            ...
            placeholder_color=kwargs.get("placeholder_color"),
            placeholder_font=kwargs.get("placeholder_font"),
            primary_color=kwargs.get("primary_color", DEFAULT_WIDGET_CONFIG["primary_color"]),
            button_icon=kwargs.get("button_icon", DEFAULT_WIDGET_CONFIG["button_icon"]),
