# ТК РФ Статья 22.2. Порядок введения электронного документооборота и приема на работу к работодателю, использующему электронный документооборот \ КонсультантПлюс
...
О применении положений данного документа (в ред. ФЗ от 22.11.2021 N 377-ФЗ) к работодателям, участвовавшим в эксперименте по использованию электронных документов, связанных с работой, см. указанный закон.
...
Ст. 22.2 ТК РФ. Порядок введения электронного документооборота и приема на работу к работодателю, использующему электронный документооборот
