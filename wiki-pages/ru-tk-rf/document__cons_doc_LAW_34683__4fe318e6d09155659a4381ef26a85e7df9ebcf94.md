# ТК РФ Статья 214. Обязанности работодателя в области охраны труда \ КонсультантПлюс
...
- В каком порядке проводится специальная оценка условий труда
...
Ст. 214 ТК РФ. Обязанности работодателя в области охраны труда
