# ГК РФ Статья 909. Проверка товаров при их приеме товарным складом и во время хранения \ КонсультантПлюс
...
ГК РФ Статья 909. Проверка товаров при их приеме товарным складом и во время хранения
...
Ст. 909 ГК РФ ч.2. Проверка товаров при их приеме товарным складом и во время хранения
