# ГК РФ Статья 1431. Селекционные достижения, созданные, выведенные или выявленные по заказу \ КонсультантПлюс
...
ГК РФ Статья 1431. Селекционные достижения, созданные, выведенные или выявленные по заказу
...
Ст. 1431 ГК РФ ч.4. Селекционные достижения, созданные, выведенные или выявленные по заказу
