...
| `db/integration.py` | ~2700 строк | 29 менеджеров — синглтоны на уровне модуля (будет заменён фасадом в Phase 2.2) |
...
**Known limitation:** доменные `__init__.py` не реэкспортируют сервисы из-за циклического импорта `db/models.py` → `modules/X/__init__.py` → `service.py` → `db/repositories` → `db/models.py`. Будет решено в Phase 2.3 ([#503](https://github.com/ShaerWare/AI_Secretary_System/issues/503)).
...
| **2** | Разделение `db/integration.py` → доменные сервисы | [#492](https://github.com/ShaerWare/AI_Secretary_System/issues/492) | 🔄 Phase 2.1 завершена ([#501](https://github.com/ShaerWare/AI_Secretary_System/issues/501)), 2.2 ([#502](https://github.com/ShaerWare/AI_Secretary_System/issues/502)) и 2.3 ([#503](https://github.com/ShaerWare/AI_Secretary_System/issues/503)) в ожидании |
