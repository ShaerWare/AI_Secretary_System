...
|---------|-----|----------|
| **anna** | Анна | Дружелюбная секретарь |
| **marina** | Марина | Профессиональный ассистент |
...
> **Workspace-фильтрация:** Провайдеры изолированы по `workspace_id`. Пользователи видят только провайдеров своего workspace. Подробнее: [[Cloud-LLM-Providers]].
