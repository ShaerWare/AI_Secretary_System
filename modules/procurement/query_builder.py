...
Правила:
- query — предмет плюс ВСЕ характеристики, названные в переписке: номинал тока,
  напряжение, число и тип контактов, сечение, длина, серия, бренд.
  Характеристики из предыдущих сообщений переноси в query, пока клиент прямо не
  отменил их. Уточнение заменяет только то, что клиент изменил.
